...
Glycemia_Data_Frame <- data.frame (
  # Repeat "Nondiabetic" 16 times and "Diabetic 16 times", to make a column of the conditions
  # Column title is "group"
  group = rep(c("NonDiabetic", "Diabetic"), each = 16),
  # Add the NonDiabetic and Diabetic values to a new column 
  # Column title is "gylcemia"
